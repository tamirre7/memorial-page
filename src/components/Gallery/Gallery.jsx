...
export default function Gallery() {
  ...
  // נתיבי הקבצים מהתיקיות
  const mediaItems = [
    { type: 'image', src: '/assets/images/gallery-01.jpg', alt: 'זיכרון של בן' },
    { type: 'video', src: '/assets/video/gallery-01.mp4', alt: 'סרטון של בן' },
    { type: 'image', src: '/assets/images/gallery-02.jpg', alt: 'זיכרון של בן' },
    { type: 'image', src: '/assets/images/gallery-03.jpg', alt: 'זיכרון של בן' },
    { type: 'image', src: '/assets/images/gallery-04.jpg', alt: 'זיכרון של בן' },
  ];
